...
# ——— 将项目根目录加入 Python Path，确保能 import looped_transformer（包在根目录）———
PROJECT_ROOT = Path(__file__).resolve().parent  # web_monitor/
PACKAGE_DIR = PROJECT_ROOT.parent               # 项目根（looped_transformer 包所在）
